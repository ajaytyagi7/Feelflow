  ...
  return (
    <div className='container-fluid page '>
        <header className='header  '>
            <div className='py-5  '>
                <h1 className='text-white fw-bold  display-4 text-center mt-5 tilt-in-bottom-2 '>Empowering Schools with <br />
                Innovative Solutions</h1>
                <p className='text-center text-white fs-5 tilt-in-bottom-2'>India's Leading Cloud-Based School Management Software</p>
                ...
                <img className='img-fluid p-3 laptop ' src={laptop} alt="" />
            </div>
        ...
        <div className="container-fluid p-5">
            ...
            <div className="row  p-5">
                <div className="col-md-3 ">
                <img className='img-fluid feature-img' src={student} alt="" />
                ...
                <div className="col-md-3">
                <img className='img-fluid feature-img' src={parents} alt="" />
                ...
                <div className="col-md-3">
                <img className='img-fluid feature-img' src={staff} alt="" />
                ...
                <div className="col-md-3">
                <img className='img-fluid feature-img' src={teacher} alt="" />
            ...
            <div className="row p-5">
                <div className="col-md-3">
                <img className='img-fluid feature-img' src={attachment} alt="" />
                ...
                <div className="col-md-3">
                <img className='img-fluid feature-img' src={library} alt="" />
                ...
                <div className="col-md-3">
                <img className='img-fluid feature-img' src={sms} alt="" />
                ...
                <div className="col-md-3">
                <img className='img-fluid feature-img' src={id} alt="" />
            ...
            <div className="row p-5">
                <div className="col-md-3">
                <img className='img-fluid feature-img' src={certificate} alt="" />
                ...
                <div className="col-md-3">
                <img className='img-fluid feature-img' src={events} alt="" />
                ...
                <div className="col-md-3">
                <img className='img-fluid feature-img' src={homework} alt="" />
                ...
                <div className="col-md-3">
                <img className='img-fluid feature-img' src={hostel} alt="" />
            ...
            <div className="row p-5">
                <div className="col-md-3">
                <img className='img-fluid feature-img' src={reception} alt="" />
                ...
                <div className="col-md-3">
                <img className='img-fluid feature-img' src={live} alt="" />
                ...
                <div className="col-md-3">
                <img className='img-fluid feature-img' src={accounting} alt="" />
            ...
            <div className="row p-5">
                ...
                <div className="col-md-3">
                <img className='img-fluid feature-img' src={exam} alt="" />
                ...
                <div className="col-md-3">
                <img className='img-fluid feature-img' src={transport} alt="" />
            ...
            <div className="row p-5">
                <div className="col-md-3">
                <img className='img-fluid feature-img' src={website} alt="" />
                ...
                <div className="col-md-3">
                <img className='img-fluid feature-img' src={whatsapp} alt="" />
                ...
                <div className="col-md-3">
                <img className='img-fluid feature-img' src={communication} alt="" />
        ...
        <div className="container-fluid bg-secondar-subtle ">
            ...
            <div className="row p-5">
                ...
                <div className="col-md-6">
                    <h4 className='fw-bold p-3'>Student Profiles Dashboard</h4>
                    <h5 className='text-secondary '>Welcome to a hassle-free admission process. Our Student Admission Dashboard feature streamlines the journey from application to enrollment. Manage inquiries, applications, and approvals seamlessly in one place. Monitor each step in real time, ensuring a smooth transition for both students and administrators. With customizable workflows and automated notifications, stay on top of every admission detail. Whether you're managing multiple campuses or a single institution, our Admission Dashboard empowers you to make informed decisions and provide an exceptional onboarding experience.</h5>
                </div>
            </div>
            ...
            <div className="row p-5">
                <div className="col-md-6">
                    <h4 className='fw-bold p-3'>Attendance Tracking</h4>
                    <h5 className='text-secondary '>Welcome to a hassle-free admission process. Our Student Admission Dashboard feature streamlines the journey from application to enrollment. Manage inquiries, applications, and approvals seamlessly in one place. Monitor each step in real time, ensuring a smooth transition for both students and administrators. With customizable workflows and automated notifications, stay on top of every admission detail. Whether you're managing multiple campuses or a single institution, our Admission Dashboard empowers you to make informed decisions and provide an exceptional onboarding experience.</h5>
                </div>
                <div className="col-md-6">
            ...
            <div className="row p-5">
                ...
                <div className="col-md-6">
                    <h4 className='fw-bold p-3'>Effortless Fee Management</h4>
                    <h5 className='text-secondary '>Welcome to a hassle-free admission process. Our Student Admission Dashboard feature streamlines the journey from application to enrollment. Manage inquiries, applications, and approvals seamlessly in one place. Monitor each step in real time, ensuring a smooth transition for both students and administrators. With customizable workflows and automated notifications, stay on top of every admission detail. Whether you're managing multiple campuses or a single institution, our Admission Dashboard empowers you to make informed decisions and provide an exceptional onboarding experience.</h5>
                </div>
            </div>
            </div>
        ...
        <div className="row  p-5">
            ...
            <div className="col-md-6 p-5">
                <img className='img-fluid tilt-in-fwd-tr' src={softmaji} alt="" />
            </div>
        </div>
        </div>
        ...
        <div className='p-5'>
            ...
            <button className=' home-btn-price shadow__btn   mt-4'>Start 30 Days Free Trail</button>
            <div className="row p-5">
                <div className="col-md-3">
                ...
                <div className="col-md-3">
                    ...
                    <p className='text-center text-color fs-2 fw-bold'>Rs.499</p>
                ...
                <h5 className='text-center text-secondary'>Neu</h5>
                    <p className='text-center text-color  fs-2 fw-bold'>Rs.799</p>
                ...
                <h5 className='text-center text-secondary'>Algon</h5>
                    <p className='text-center text-color  fs-2 fw-bold'>Rs.999</p>
                ...
                <div className='row mt-5'>
                   ...
                   <div className="col-md-3">
                    <button className='cssbuttons-io-button1 price-btn'>Get Started</button>
                   </div>
                   <div className="col-md-3">
                   <button className='cssbuttons-io-button1 price-btn'>Get Started</button>
        ...
        <div className='support p-5'>
            <div className="row text-light ">
                <div className="col-md-3">
                    ...
                    <p className=''>FeeFlow Technologies is a leading provider of innovative school management software. With a deep understanding of the challenges faced by educational institutions, we have developed a powerful cloud-based platform that simplifies administrative tasks and empowers educators to focus on student success.</p>
                </div>
                <div className="col-md-3">
                    ...
                    <p className='fw-bold'>How To's</p>
                ...
                <div className="col-md-3">
                    ...
                    <p className='fw-bold'>Abouts Us</p>
                    <p className='fw-bold'>Contact US</p>
                    <p className='fw-bold'>Privacy And Policy </p>
                ...
                <div className="col-md-3">
                    ...
                    <p className='fw-bold'>SoftMaji InfoTech Private Limited
                    CIN U72900UP2021PTC146111
                    Address: 4/40 Vipul Khand, Gomti Nagar
                    Lucknow, Uttar Pradesh 226010
                    Mobile: 01169650106
                    Email: hello@feeflow.in
                    </p>
        ...
        <div className='bg-dark text-light ' >
            <div className="row p-4 mx-5">
                <div className="col-md-6">
                    <p className='fw-bold'>© 2024 All Right Reserved - FeeFlow Technologies</p>
                </div>
                <div className="col-md-6">
                    <p className='fw-bold'>Crafted with Pride by SoftMaji</p>
                </div>
            </div>
        </div>
